...
// This will help get list of all the records
...
//Sign-up method, which allows user so sign up
...
// to encrypt password when editing the user
  const password = bcrypt.hash(req.body.password,10)
...
router.post("/login",bruteforce.prevent, async (req, res) => {
  ...
  try {
    ...
    //Authentication successful output
